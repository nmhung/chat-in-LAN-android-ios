...
public class AlertDialogUtils {
    ...
    public static Dialog showInfo(Context context, String des) {
        return showInfo(context, des, context.getString(android.R.string.ok), null);
    }
    ...
    public static Dialog showConfirmNotCancelable(Context context, String title, String msg,
                                                  DialogInterface.OnClickListener onYesListener, DialogInterface.OnClickListener onNoListener) {
    ...
    public static Dialog showConfirmNotCancelable(Context context, String msg, String textYes,
                                                  String textNo, DialogInterface.OnClickListener onYesListener,
